...
const ENDLESS_MINT = 'FFEjZnvY1tqHyBAMBPE1DHoEmQWLmxjhvvDs4TaRBAGS';
...
// Sell 33% of 725,307.854 tokens = ~239,351 tokens (BAGS tokens have 6 decimals)
const DECIMALS = 6;
const sellAmount = Math.floor(239351 * Math.pow(10, DECIMALS));
console.log(`Selling ~239,351 ENDLESS (33% partial profit at +68%)`);
console.log(`Raw amount: ${sellAmount}`);

// Get quote
const quoteUrl = `https://quote-api.jup.ag/v6/quote?inputMint=${ENDLESS_MINT}&outputMint=${SOL_MINT}&amount=${sellAmount}&slippageBps=100`;
...
console.log('✅ PARTIAL PROFIT TAKEN: $ENDLESS +68%');
